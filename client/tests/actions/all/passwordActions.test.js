...
describe('PASSWORD ACTIONS', () => {
  ...
  it('should create PASSWORD_IS_LOADING and toast a message for sending reset password link ', (done) => {
  ...
  it('should create PASSWORD_IS_LOADING and toast an error for sending reset password link ', (done) => {
    moxios.stubRequest('/api/user/password', {
      status: 400,
      response: {
        data: {
  ...
  it('should create PASSWORD_IS_LOADING and toast a message for successfully resetting password ', (done) => {
  ...
  it('should create PASSWORD_IS_LOADING and toast an error for resetting password', (done) => {
    moxios.stubRequest('/api/user/password/reset', {
      status: 400,
      response: {
        message: 'an error occured'
